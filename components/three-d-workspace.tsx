      ...
      >
        <div className="p-4 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between bg-background">
          <div className="flex items-center gap-2 truncate pr-2">
            ...
            <h2 className="font-black text-sm tracking-tight truncate">
              {title}
            </h2>
          </div>
          ...
          <section>
            ...
            <div className="space-y-3">
              {vectors.map((v) => (
                <div
                  key={v.id}
                  className="p-4 bg-transparent border border-border rounded-2xl space-y-3 group transition-all duration-300 relative overflow-hidden"
                >
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    <div className="space-y-1">
                      <label className="text-[10px] uppercase font-bold text-muted-foreground/60">
                        X
                      </label>
                      <Input
                        value={v.x}
                        onChange={(e) =>
                          updateVector(v.id, "x", e.target.value)
                        }
                        onFocus={() =>
                          setActiveInput({
                            type: "vector",
                        ...
                        className="h-8 text-center bg-transparent border-none shadow-none rounded-none"
                      />
                    </div>
                    <div className="space-y-1">
                      <label className="text-[10px] uppercase font-bold text-muted-foreground/60">
                      ...
                      <Input
                        value={v.y}
                        onChange={(e) =>
                          updateVector(v.id, "y", e.target.value)
                        }
                        onFocus={() =>
                          setActiveInput({
                            type: "vector",
                    ...
                    <div className="space-y-1">
                      ...
                      <Input
                        value={v.z}
                        onChange={(e) =>
                          updateVector(v.id, "z", e.target.value)
                        }
                        onFocus={() =>
                          setActiveInput({
                            type: "vector",
          ...
          <section>
            ...
            <div className="space-y-3">
              {surfaces.map((s) => (
                <div
                  key={s.id}
                  className="p-4 bg-transparent border border-border rounded-2xl space-y-3 group Transition-all"
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div
                  ...
                  <div className="space-y-1">
                    ...
                    <Input
                      ...
                      className="h-8 font-mono text-sm bg-transparent border-none shadow-none rounded-none"
                    />
                  </div>
                </div>
              ))}
        ...
        <div className="p-4 border-t border-border bg-background flex gap-2">
          <Button
            ...
            size="sm"
            className={cn(
              "h-10 px-4 grow gap-2 rounded-xl",
              keyboardOpen ? "bg-primary text-primary-foreground" : "",
            )}
        ...
        <div className="absolute top-6 left-6 flex items-center gap-2">
          {!sidebarOpen && (
            <Button
              ...
              className="bg-background shadow-lg border border-border rounded-full h-10 w-10"
            >
