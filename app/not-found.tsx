...
export default function NotFound() {
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center p-4 bg-background relative overflow-hidden">
      ...
      <div
        className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-emerald-500/10 rounded-full blur-[100px] animate-pulse"
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-2xl">
        ...
        >
          <Button
            asChild
            size="lg"
            className="rounded-2xl h-14 px-8 font-black text-lg shadow-xl shadow-primary/20 hover:scale-105 active:scale-95 transition-all"
          >
            <Link href="/">
          ...
          <Button
            ...
            variant="outline"
            size="lg"
            className="rounded-2xl h-14 px-8 font-black text-lg border-2 hover:bg-accent border-zinc-200 dark:border-zinc-800 hover:scale-105 active:scale-95 transition-all"
          >
        ...
        <div className="absolute -z-10 w-full h-full pointer-events-none opacity-20 dark:opacity-10">
          <div className="absolute top-10 left-10 text-6xl font-serif rotate-12">
            ∫
          </div>
          <div className="absolute bottom-20 left-20 text-4xl font-serif -rotate-12">
            π
          </div>
          <div className="absolute top-20 right-20 text-5xl font-serif rotate-45">
            Σ
          </div>
          <div className="absolute bottom-10 right-10 text-6xl font-serif -rotate-6">
            ∞
          </div>
          <div className="absolute top-1/2 left-[-2rem] text-4xl font-serif">
            √
          </div>
          <div className="absolute top-1/2 right-[-2rem] text-4xl font-serif">
            Δ
          </div>
        </div>
      </div>
