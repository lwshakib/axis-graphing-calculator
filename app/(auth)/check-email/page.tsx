    ...
    <Card className="border-none shadow-none bg-transparent">
      ...
      <CardContent className="space-y-4 text-center">
        <p className="text-sm text-muted-foreground leading-relaxed">
          ...
          <strong className="text-foreground font-black">
            Access to persistent graphing and 3D workspaces is locked until your
            identity is confirmed.
          </strong>
        </p>
        <Button
          asChild
          className="w-full h-11 font-bold shadow-xl shadow-primary/20"
        >
          <a
      ...
      <CardFooter>
        <Button
          asChild
          variant="ghost"
          className="w-full h-10 font-bold text-muted-foreground hover:text-primary"
        >
